...
const transferFromAmount = (url,token_address,privateKey,receiverAddress,owneraddress,amount) => {
    transferfrom = async () => {
    ...
    let token =  transferfrom().then((res)=>{return res}).catch((err) => console.log('Err',err))
    return token;
}
