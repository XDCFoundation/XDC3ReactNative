...
const _safeTransferFrom = (url,token_address,spendarprivateKey,receiverAddress,spenderAddress,tokenId) => {
    safetransfer = async () => {
        ...
        let newmethod = await contract.populateTransaction.safeTransferFrom(spenderAddress,receiverAddress, tokenId);
        let txn = {
